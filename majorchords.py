# Program to generate the sounds of notes of a major chord arpeggio matching the frequencies of notes in piano
...
def load_notes(notestep, notestep1):
    ...
    print()
    print(f'The frequencies of descending notes of the major chords for note {notescale}')
    ...
    # Return list of frequencies in the ascending and descending notes of the major chords    
...
# Scale list for which the major chords will be played in sequence
scale_list = ['C4','D4','E4','F4','G4','A4','B4','C5']
...
for notescale in scale_list:
    ...
    tones_fwd, tones_rev = load_notes(notestep, notestep1)
